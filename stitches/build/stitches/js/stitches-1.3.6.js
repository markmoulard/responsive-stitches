...
define("wrap/jquery", [], function () {
    ...
    function () {
        ...
        return function (obj) {
            ...
            with(obj || {}) __p.push(".", prefix, " {\\n    background-image: url(", backgroundImage, ");\\n"), units == "pixel" ? __p.push("    background-repeat: no-repeat;\\n") : __p.push("    max-width: 100%;\\n"), __p.push("    display: block;\\n}\\n"), $.map(sprites, function (e) {
                __p.push("\\n"), units == "percent" && __p.push(".", prefix, "-", e.name, "-sizeNormal {\\n    width: ", e.width, "px;\\n    height: ", e.height, "px;\\n}\\n"), __p.push(".", prefix, "-", e.name, " {\\n"), units == "percent" ? __p.push("    background-size : ", canvasWidth / e.width * 100, "% ", canvasHeight / e.height * 100, "%;\\n    background-position: ", e.left() / (canvasWidth - e.width) * 100, "% ", e.top() / (canvasHeight - e.height) * 100, "%;\\n") : __p.push("    width: ", e.width, "px;\\n    height: ", e.height, "px;\\n    background-position: -", e.left(), "px -", e.top(), "px;\\n"), __p.push("}\\n")
            }), __p.push("");
            return __p.join("")
        }
        ...
        return function (obj) {
            ...
            with(obj || {}) __p.push(""), $.map(sprites, function (e) {
                __p.push(""), tooltip ? __p.push('<i class="', prefix, " ", prefix, "-", e.name, " ", prefix, "-", e.name, '-sizeNormal" data-toggle="tooltip" title=".', prefix, ".", prefix, "-", e.name, '"></i>\\n') : __p.push('<i class="', prefix, " ", prefix, "-", e.name, '"></i>\\n'), __p.push("")
            }), __p.push("");
            return __p.join("")
        }
        ...
        return function (obj) {
            ...
            with(obj || {}) __p.push(""), units == "pixel" ? __p.push(".stitches-", prefix, "(@x: 0, @y: 0, @width: 0, @height: 0) {\\n    background-position: @x @y;\\n    width: @width;\\n    height: @height;\\n}\\n") : units == "percent" && __p.push(".stitches-", prefix, "(@x: 0, @y: 0, @width: 0, @height: 0) {\\n    background-position: percentage(@x / (", canvasWidth, " - @width)) percentage(@y / (", canvasHeight, " - @height));\\n    background-size: percentage(", canvasWidth, " / @width) percentage(", canvasHeight, " / @height);\\n}\\n"), __p.push("\\n"), units == "percent" && __p.push(".stitches-", prefix, "-sizeNormal(@width: 0, @height: 0) {\\n    width: @width;\\n    height: @height;\\n}\\n"), __p.push(".", prefix, " {\\n    background-image: url(", backgroundImage, ");\\n"), units == "pixel" ? __p.push("    background-repeat: no-repeat;\\n") : units == "percent" && __p.push("    max-width: 100%;\\n"), __p.push("    display: block;\\n"), $.map(sprites, function (e) {
                __p.push("\\n"), units == "percent" && __p.push("    &.", prefix, "-", e.name, "-sizeNormal {\\n        .stitches-", prefix, "-sizeNormal(", e.width, "px, ", e.height, "px);\\n    }\\n"), __p.push("    &.", prefix, "-", e.name, " {\\n"), units == "pixel" ? __p.push("        .stitches-", prefix, "(-", e.left(), "px, -", e.top(), "px, ", e.width, "px, ", e.height, "px);\\n") : units == "percent" && __p.push("        .stitches-", prefix, "(", e.left(), ", ", e.top(), ", ", e.width, ", ", e.height, ");\\n"), __p.push("    }\\n")
            }), __p.push("}\\n");
            return __p.join("")
        }
        ...
        return function (obj) {
            ...
            with(obj || {}) __p.push(""), $.map(sprites, function (e) {
                __p.push(""), tooltip ? __p.push('<i class="', prefix, " ", prefix, "-", e.name, " ", prefix, "-", e.name, '-sizeNormal" data-toggle="tooltip" title=".', prefix, ".", prefix, "-", e.name, '"></i>') : __p.push('<i class="', prefix, " ", prefix, "-", e.name, '"></i>\\n'), __p.push("")
            }), __p.push("");
            return __p.join("")
        }
    }), define("tpl!util/../../templates/sass.tpl", function () {
        return function (obj) {
            var __p = [],
                print = function () {
                    __p.push.apply(__p, arguments)
                };
            with(obj || {}) __p.push(""), units == "pixel" ? __p.push("@mixin stitches-", prefix, "($x: 0, $y: 0, $width: 0, $height: 0)\\n    background-position: $x $y\\n    width: $width\\n    height: $height\\n\\n") : units == "percent" && __p.push("@mixin stitches-", prefix, "($x: 0, $y: 0, $width: 0, $height: 0)\\n    background-position: percentage($x / (", canvasWidth, " - $width)) percentage($y / (", canvasHeight, " - $height))\\n    background-size: percentage(", canvasWidth, " / $width) percentage(", canvasHeight, " / $height)\\n\\n"), __p.push(""), units == "percent" && __p.push("@mixin stitches-", prefix, "-sizeNormal($width: 0, $height: 0)\\n    width: $width\\n    height: $height\\n\\n"), __p.push(".", prefix, " \\n    background-image: url(", backgroundImage, ")\\n"), units == "pixel" ? __p.push("    background-repeat: no-repeat\\n") : __p.push("    max-width: 100%\\n"), __p.push("    display: block\\n"), $.map(sprites, function (e) {
                __p.push(""), units == "percent" && __p.push("    .", prefix, "-", e.name, "-sizeNormal\\n        @include stitches-", prefix, "-sizeNormal(", e.width, "px, ", e.height, "px)\\n    \\n"), __p.push("    ", prefix, "-", e.name, "\\n"), units == "pixel" ? __p.push("        @include stitches-", prefix, "(", e.left(), "px, ", e.top(), "px, ", e.width, "px, ", e.height, "px)\\n") : units == "percent" && __p.push("        @include stitches-", prefix, "(", e.left(), ", ", e.top(), ", ", e.width, ", ", e.height, ")\\n"), __p.push("    \\n")
            }), __p.push("\\n");
            return __p.join("")
        }
    }), define("tpl!util/../../templates/sass-markup.tpl", function () {
        return function (obj) {
            var __p = [],
                print = function () {
                    __p.push.apply(__p, arguments)
    ...
    }), define("util/templates", ["tpl!../../templates/stitches.tpl", "tpl!../../templates/downloads.tpl", "tpl!../../templates/sprite.tpl", "tpl!../../templates/css.tpl", "tpl!../../templates/css-markup.tpl", "tpl!../../templates/less.tpl", "tpl!../../templates/less-markup.tpl", "tpl!../../templates/sass.tpl", "tpl!../../templates/sass-markup.tpl"], function (e, t, n, r, i, s, o, u, a) {
        return {
            stitches: function () {
        ...
        return t.inherit(s, r, {
            ...
            get: function (e, t, r, i, s, o, u) {
                var a = i ? t : this.settings.filename;
                return n.css({
                    prefix: r,
                    backgroundImage: a,
                    sprites: e,
    ...
    }), define("stylesheet/sass", ["wrap/jquery", "util/util", "util/templates", "stylesheet/base"], function (e, t, n, r) {
        var i = {
                filename: "spritesheet.png"
            },
            s = function (t) {
    ...
    }), define("manager/stylesheet", ["wrap/jquery", "stylesheet/css", "stylesheet/less", "stylesheet/sass"], function (e, t, n, r) {
        var i = {
            css: t,
            less: n,
            sass: r
        ...
        return {
            set: function (e) {
                var t;
                this.type = e || "css", t = i[this.type], this.manager = new t
            },
            getStylesheet: function (e) {
                var t = e.sprites,
                    ...
                    o = e.height,
                    u = e.units,
                    a = this.manager.get(t, n, r, i, s, o, u);
                return a = a.replace(/\\n/g, "\n"), a
            },
        ...
        var h = "pixel",
            ...
            v = function (t, n) {
                this.$element = e(t), this.settings = e.extend({}, d, n), this.init()
            };
        return v.prototype = {
            constructor: v,
            init: function () {
            ...
            configure: function () {
                var t;
                n && !n.disabled && (t = n.get("stitches-settings")), t && (t.units || (t.units = h), this.settings = e.extend(this.settings, t))
            },
            render: function () {
                var e = i.stitches({});
                ...
                var t = this,
                    ...
                    i = new c(this.$settings, {
                        ...
                        fields: {
                            ...
                            units: {
                                change: function (e) {
                                    var n = this.$element.find("input[name=units]:checked"),
                                        r = n.val();
                                    t.settings.units = r, t.updateSettings()
                                }
                            },
                            prefix: {
            ...
            importData: function (t) {
                var n = this,
                    ...
                    i = t.canvas || {},
                    s = i.sprites || [];
                this.settings = e.extend({}, d, r), o.set(this.settings.layout), u.set(this.settings.stylesheet), this.updateSettings(), this.canvas.clear(), this.canvas.settings.padding = this.settings.padding, e.map(s, function (e) {
